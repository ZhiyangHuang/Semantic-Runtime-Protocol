# LongMemEval Bridge Execution Record V3
...
- note: v1 and v2 bridge outputs are retained as iteration history; v3 is the corrected official bridge artifact
...
- bridge output dir: `experiments/results/longmemeval_full_v3`
...
```text
python -c "from experiments.benchmarks.longmemeval import run_longmemeval_bridge; print(run_longmemeval_bridge(output_dir='experiments/results/longmemeval_full_v3'))"
```
