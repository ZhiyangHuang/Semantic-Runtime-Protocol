# LongMemEval Bridge Execution Record V2
...
- note: v1 bridge output is retained as a diagnostic artifact; v2 is the corrected official bridge artifact
...
- bridge output dir: `experiments/results/longmemeval_full_v2`
...
```text
python -c "from experiments.benchmarks.longmemeval import run_longmemeval_bridge; print(run_longmemeval_bridge(output_dir='experiments/results/longmemeval_full_v2'))"
```
