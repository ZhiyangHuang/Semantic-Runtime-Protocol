# LongMemEval Bridge Execution Record V1
...
- working tree: dirty outside this bridge scope, but `paper/` remains clean in the active worktree
...
- bridge output dir: `experiments/results/longmemeval_full_v1`
...
```text
python -c "from experiments.benchmarks.longmemeval import run_longmemeval_bridge; print(run_longmemeval_bridge())"
```
