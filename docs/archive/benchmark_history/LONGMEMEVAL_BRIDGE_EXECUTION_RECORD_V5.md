# LongMemEval Bridge Execution Record V5
...
- note: v1-v4 bridge outputs are retained as iteration history; v5 is the corrected official bridge artifact
...
- bridge output dir: `experiments/results/longmemeval_full_v5`
...
```text
python -c "from experiments.benchmarks.longmemeval import run_longmemeval_bridge; print(run_longmemeval_bridge(output_dir='experiments/results/longmemeval_full_v5'))"
```
