...
def adapt_reasoning_slice(raw_cases: Iterable[dict], runtime_contract: str) -> list[BoundaryCase]:
    del raw_cases, runtime_contract
    raise NotImplementedError("Reasoning adapter scaffold is registered but not implemented")
