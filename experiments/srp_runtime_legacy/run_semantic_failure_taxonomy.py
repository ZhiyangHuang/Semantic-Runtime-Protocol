...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=[],
        help="Input JSONL file or directory. Repeatable. Defaults to experiments/results/analysis/fixed_harnesses.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "experiments" / "results" / "analysis" / "semantic_failure_taxonomy",
...
def main() -> int:
    args = parse_args()
    inputs = args.input or [PROJECT_ROOT / "experiments" / "results" / "analysis" / "fixed_harnesses"]
