...
def build_transition_candidate(case: BenchmarkCase, event: SelectedLongMemEvalEvent) -> TransitionCandidate:
    ...
    if event.probe_mode == "counterfactual":
    ...
    claim_id = {
        ...
        "contradiction_resolution": "rejected_transition_preserves_state",
    ...
    return TransitionCandidate(
        ...
        provenance={
            ...
            "real_sample": event.source_mode == "real_cases_jsonl",
            "probe_mode": event.probe_mode,
        },
