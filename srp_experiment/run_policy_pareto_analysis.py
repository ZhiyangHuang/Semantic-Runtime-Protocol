...
from srp_experiment.analysis.policy_pareto import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--records-jsonl",
        type=Path,
        default=PROJECT_ROOT / "srp_experiment" / "tmp" / "policy_intervention" / "policy_intervention_records.jsonl",
        help="Policy intervention JSONL file.",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "srp_experiment" / "tmp" / "policy_pareto",
