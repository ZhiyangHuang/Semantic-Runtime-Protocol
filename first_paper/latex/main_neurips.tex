...
\IfFileExists{../figures/SRP vs Memory vs Agent vs Compression.png}{}{%
  \PackageError{SRP}{Missing comparison figure}{Place the image in first_paper/figures/ or update the path in main_neurips.tex.}%
}
...
This section is intentionally left blank for the draft. Replace it in the camera-ready version.
