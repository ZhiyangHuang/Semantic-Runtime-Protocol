...
\IfFileExists{../figures/SRP vs Memory vs Agent vs Compression.png}{}{%
  \PackageError{SRP}{Missing comparison figure}{Place the image in first_paper/figures/ or update the path in main_acl.tex.}%
}
...
The main question is whether SRP exhibits a slower increase in cumulative semantic drift than lightweight baselines. If the SRP curve grows more slowly or remains flatter over the finite horizon, this would support the core claim that explicit semantic-state management can stabilize repeated transformation.
