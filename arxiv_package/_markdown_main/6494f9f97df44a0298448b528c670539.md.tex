...
{}The main result is that the SRP-governed recovery implementation yields higher structural fidelity under the same recovery budget:\markdownRendererInterblockSeparator
{}\markdownRendererTable{}{4}{6}{drrrrd}{{Mode}{Mean Relation Acc.}{Mean Closure Acc.}{Mean Drift}{Mean Hallucinated Rel. Rate}{Meaning}}{{vector\markdownRendererUnderscore{}only}{0.333333}{0.166667}{0.433333}{0.0}{Baseline vector-only recovery}}{{relation\markdownRendererUnderscore{}expansion}{0.875}{0.8125}{0.145834}{0.3125}{Relation expansion adds detail\markdownRendererInlineHtmlTag{<br>}but still hallucinates some relations}}{{relation\markdownRendererUnderscore{}closure}{0.875}{0.8125}{0.083333}{0.0}{Relation closure preserves structure\markdownRendererInlineHtmlTag{<br>}with no hallucinated relations}}\markdownRendererInterblockSeparator
...
{}\markdownRendererTable{}{8}{5}{drrrd}{{Setting}{Coverage}{Drift}{Cost}{Meaning}}{{Baseline (\markdownRendererCodeSpan{archive=False}, \markdownRendererCodeSpan{preserve=False},\markdownRendererInlineHtmlTag{<br>}\markdownRendererCodeSpan{depth=1}, \markdownRendererCodeSpan{threshold=0.9})}{0.728095}{0.098333}{1.695}{Reference point}}{{\markdownRendererCodeSpan{archive=True}}{0.758095}{0.077083}{1.815}{More relation detail,\markdownRendererInlineHtmlTag{<br>}higher cost}}{{\markdownRendererCodeSpan{preserve=True}}{0.738095}{0.083333}{1.755}{Slight stability gain,\markdownRendererInlineHtmlTag{<br>}moderate cost increase}}{{\markdownRendererCodeSpan{depth=0}}{0.199643}{0.628333}{1.025}{Vector-like recovery,\markdownRendererInlineHtmlTag{<br>}weak structure}}{{\markdownRendererCodeSpan{depth=2}}{0.839524}{0.0}{1.855}{Best result in the sweep}}{{\markdownRendererCodeSpan{depth=3}}{0.849524}{0.005}{2.015}{Highest coverage,\markdownRendererInlineHtmlTag{<br>}highest cost}}{{\markdownRendererCodeSpan{threshold=0.1}}{0.792095}{0.138333}{1.711}{More permissive\markdownRendererInlineHtmlTag{<br>}gating, more drift}}\markdownRendererInterblockSeparator
