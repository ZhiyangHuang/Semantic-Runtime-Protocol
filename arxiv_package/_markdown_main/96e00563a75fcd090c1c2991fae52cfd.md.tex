...
{}The release-facing main evidence set is MMLU, LongMemEval, ARC, and HumanEval, with 100 samples each for a total of 400 samples. LongMemEval is one of those Main Evidence benchmarks under a frozen shared local-vLLM runtime contract. The evidence package includes:\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
...
\markdownRendererUlEndTight \markdownRendererInterblockSeparator
{}The current snapshot contains four Main Evidence benchmarks:\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
\markdownRendererUlItem \markdownRendererCodeSpan{MMLU}\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererCodeSpan{LongMemEval}\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererCodeSpan{ARC}\markdownRendererUlItemEnd 
\markdownRendererUlItem \markdownRendererCodeSpan{HumanEval}\markdownRendererUlItemEnd 
\markdownRendererUlEndTight \markdownRendererInterblockSeparator
...
\markdownRendererUlItem the four main evidence benchmarks are MMLU, LongMemEval, ARC, and HumanEval\markdownRendererUlItemEnd 
...
\markdownRendererUlItem the main evidence benchmarks are promoted through the release summary and should be cited from there\markdownRendererUlItemEnd 
\markdownRendererUlEndTight \markdownRendererInterblockSeparator
...
{}The release-facing benchmark set is treated as Main Evidence under the frozen release boundary.\markdownRendererParagraphSeparator
{}It is classified as:\markdownRendererInterblockSeparator
{}\markdownRendererUlBeginTight
\markdownRendererUlItem benchmark evidence\markdownRendererUlItemEnd 
