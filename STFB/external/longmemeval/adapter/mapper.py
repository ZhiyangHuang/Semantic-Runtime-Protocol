...
def map_longmemeval_case(raw_case: Dict[str, Any], source_case_id: str) -> Dict[str, Any]:
    ...
    return {
        "instance_id": f"lme_{source_case_id}",
        ...
        "evidence": {
            "retrieved_items": list(retrieved_units) or list(raw_case.get("focus_unit_ids", [])),
            "retrieved_relations": list(retrieved_relations) or list(raw_case.get("focus_relation_ids", [])),
            "confidence": score,
        },
        "authority": {
