...
| --- | --- | --- | --- |
| Direct Mutation | commit | reject | No admission boundary prevents the older proposal from entering runtime state. |
| Confidence Threshold | reject | reject | The proposal is not committed because the confidence score is below the threshold. |
...
| Confidence Threshold | commit | reject | Strong evidence is treated as sufficient permission to commit. |
