...
These cases were chosen because they exercise two distinct governance pressures without changing the STFB core schema:

- state freshness: whether older memory can overwrite a newer authoritative state
- authority boundary: whether retrieved evidence is treated as permission to mutate
